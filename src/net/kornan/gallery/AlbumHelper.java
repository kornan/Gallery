...
public class AlbumHelper {
	...
	public List<ImageItem> getImagesItemList() {
		List<ImageBucket> tmpBucketList=getImagesBucketList(false);
		List<ImageItem> tmpItemList = new ArrayList<ImageItem>();
		for(ImageBucket iBucket:tmpBucketList){
			tmpItemList.addAll(iBucket.imageList);
		}
		return tmpItemList;
	}
